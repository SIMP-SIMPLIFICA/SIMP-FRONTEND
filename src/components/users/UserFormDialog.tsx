  ...
  useEffect(() => {
    if (open) {
      if (user) {
        ...
        // No modo edição, geralmente não editamos roles aqui para evitar complexidade,
        // mas se quiser, poderia pré-carregar. Por enquanto, focaremos em dados cadastrais.
      } else {
        // Modo Criação
        setFirstName("");
        setLastName("");
