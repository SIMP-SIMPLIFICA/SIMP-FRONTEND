...
import { Search, X, Paperclip, Send, Loader2, FileText, Reply } from "lucide-react";
                    ...
                    {searching ? (
                      ...
                      searchResults.map(r => (
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-3 py-2.5 text-left transition-colors border-b border-slate-50 last:border-0 hover:bg-emerald-50"
                        >
                          <div className="h-8 w-8 rounded-full flex items-center justify-center text-xs font-semibold text-white shrink-0 bg-emerald-600">
